  ...
  try {
    ...
    return NextResponse.json({
      ...
      seed: {
        ...
        // Track A additions
        firmCategories: seed.firmCategories,
        techCategories: seed.techCategories,
        deliveryModels: seed.deliveryModels,
        serviceCategories: seed.serviceCategories,
        services: seed.services,
        industryHierarchy: seed.industryHierarchy,
        marketHierarchy: seed.marketHierarchy,
        companyNodes: seed.companyNodes,
