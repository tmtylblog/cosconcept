...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-cos-cloud">
      <div className="w-full max-w-sm space-y-6 rounded-cos-xl border border-cos-border bg-cos-surface p-8 shadow-sm">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-cos-midnight">
            Collective OS
          </h1>
          <p className="mt-1 text-sm text-cos-slate">
            {isSignUp ? "Create your account" : "Sign in to grow faster together"}
          </p>
        </div>
        ...
        {status && (
          <div className="rounded-cos-lg bg-blue-50 p-3 text-sm text-blue-600">
            {status}
          </div>
        )}
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            {isSignUp && (
              <input
                ...
                className="w-full rounded-cos-lg border border-cos-border bg-cos-surface px-3 py-2 text-sm text-cos-midnight placeholder:text-cos-slate-light focus:border-cos-electric focus:outline-none focus:ring-1 focus:ring-cos-electric"
              />
            )}
            <input
              type="email"
