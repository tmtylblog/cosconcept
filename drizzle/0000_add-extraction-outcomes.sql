...
CREATE TYPE "public"."lead_status" AS ENUM('draft', 'open', 'shared', 'claimed', 'won', 'lost', 'expired');--> statement-breakpoint
...
CREATE TYPE "public"."specialist_profile_source" AS ENUM('ai_generated', 'user_created', 'ai_suggested_user_confirmed', 'legacy_import');--> statement-breakpoint
...
CREATE TABLE "domain_aliases" (
	...
	"created_by" text,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "domain_aliases_domain_unique" UNIQUE("domain")
);
--> statement-breakpoint
...
CREATE TABLE "extraction_outcomes" (
	...
	"auto_extracted_count" integer DEFAULT 0 NOT NULL,
	"manually_added_count" integer DEFAULT 0 NOT NULL,
	"manually_added_items" jsonb,
	"failure_reason" text,
...
--> statement-breakpoint
CREATE TABLE "growth_ops_conversations" (
	"id" text PRIMARY KEY NOT NULL,
	"linkedin_account_id" text NOT NULL,
	"chat_id" text NOT NULL,
	"participant_provider_id" text DEFAULT '' NOT NULL,
	...
	"is_inmail_thread" boolean DEFAULT false NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "growth_ops_daily_usage" (
	"id" text PRIMARY KEY NOT NULL,
	"linkedin_account_id" text NOT NULL,
	"date" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "growth_ops_hubspot_cache" (
	"id" text PRIMARY KEY NOT NULL,
	"deal_id" text NOT NULL,
	"pipeline_id" text NOT NULL,
	"pipeline_label" text DEFAULT '' NOT NULL,
	"stage_id" text NOT NULL,
	"stage_label" text DEFAULT '' NOT NULL,
	"stage_order" integer DEFAULT 0 NOT NULL,
	"deal_data" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"synced_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "growth_ops_hubspot_cache_deal_id_unique" UNIQUE("deal_id")
);
--> statement-breakpoint
CREATE TABLE "growth_ops_invite_campaigns" (
	"id" text PRIMARY KEY NOT NULL,
	"name" text NOT NULL,
	"target_list_id" text NOT NULL,
	"linkedin_account_id" text NOT NULL,
	"status" text DEFAULT 'draft' NOT NULL,
	"daily_min" integer DEFAULT 15 NOT NULL,
	"daily_max" integer DEFAULT 19 NOT NULL,
	"invite_message" text,
	"active_days" jsonb DEFAULT '["mon","tue","wed","thu","fri","sat"]'::jsonb NOT NULL,
	"active_hours_start" integer DEFAULT 8 NOT NULL,
	"active_hours_end" integer DEFAULT 18 NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "growth_ops_invite_queue" (
	"id" text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "growth_ops_invite_targets" (
	"id" text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "growth_ops_linkedin_accounts" (
	"id" text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "growth_ops_messages" (
	"id" text PRIMARY KEY NOT NULL,
	"linkedin_account_id" text NOT NULL,
	"chat_id" text NOT NULL,
	"message_id" text NOT NULL,
	"sender_provider_id" text DEFAULT '' NOT NULL,
	"is_outbound" boolean DEFAULT false NOT NULL,
	"body" text DEFAULT '' NOT NULL,
	"is_read" boolean DEFAULT false NOT NULL,
	"is_inmail" boolean DEFAULT false NOT NULL,
	"sent_at" timestamp DEFAULT now() NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "growth_ops_messages_message_id_unique" UNIQUE("message_id")
);
--> statement-breakpoint
CREATE TABLE "growth_ops_target_lists" (
	"id" text PRIMARY KEY NOT NULL,
	"name" text NOT NULL,
	"description" text,
	"created_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "legacy_users" (
	...
	"legacy_org_id" text,
	"legacy_org_name" text,
	"first_name" text,
	"last_name" text,
	"email" text,
	"title" text,
	"legacy_roles" jsonb DEFAULT '[]'::jsonb,
	"firm_id" text,
	"user_id" text,
	"created_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "partner_preferences" (
	...
	"rate_start" integer,
	"rate_end" integer,
	"project_size_ranges" jsonb,
	"preferences_synced_at" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "service_firms" (
	...
	"graph_node_id" text,
	"is_cos_customer" boolean DEFAULT false,
	"cos_customer_since" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "subscriptions" (
	...
	"gift_return_plan" "subscription_plan",
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
ALTER TABLE "acq_contacts" ADD CONSTRAINT "acq_contacts_company_id_acq_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."acq_companies"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "acq_deals" ADD CONSTRAINT "acq_deals_contact_id_acq_contacts_id_fk" FOREIGN KEY ("contact_id") REFERENCES "public"."acq_contacts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "acq_deals" ADD CONSTRAINT "acq_deals_company_id_acq_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."acq_companies"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "attribution_events" ADD CONSTRAINT "attribution_events_contact_id_acq_contacts_id_fk" FOREIGN KEY ("contact_id") REFERENCES "public"."acq_contacts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "attribution_events" ADD CONSTRAINT "attribution_events_linkedin_campaign_id_growth_ops_invite_campaigns_id_fk" FOREIGN KEY ("linkedin_campaign_id") REFERENCES "public"."growth_ops_invite_campaigns"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "attribution_events" ADD CONSTRAINT "attribution_events_linkedin_invite_target_id_growth_ops_invite_targets_id_fk" FOREIGN KEY ("linkedin_invite_target_id") REFERENCES "public"."growth_ops_invite_targets"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "domain_aliases" ADD CONSTRAINT "domain_aliases_firm_id_service_firms_id_fk" FOREIGN KEY ("firm_id") REFERENCES "public"."service_firms"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "domain_aliases" ADD CONSTRAINT "domain_aliases_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "growth_ops_conversations" ADD CONSTRAINT "growth_ops_conversations_linkedin_account_id_growth_ops_linkedin_accounts_id_fk" FOREIGN KEY ("linkedin_account_id") REFERENCES "public"."growth_ops_linkedin_accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "growth_ops_daily_usage" ADD CONSTRAINT "growth_ops_daily_usage_linkedin_account_id_growth_ops_linkedin_accounts_id_fk" FOREIGN KEY ("linkedin_account_id") REFERENCES "public"."growth_ops_linkedin_accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "growth_ops_invite_campaigns" ADD CONSTRAINT "growth_ops_invite_campaigns_target_list_id_growth_ops_target_lists_id_fk" FOREIGN KEY ("target_list_id") REFERENCES "public"."growth_ops_target_lists"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "growth_ops_invite_campaigns" ADD CONSTRAINT "growth_ops_invite_campaigns_linkedin_account_id_growth_ops_linkedin_accounts_id_fk" FOREIGN KEY ("linkedin_account_id") REFERENCES "public"."growth_ops_linkedin_accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "growth_ops_invite_queue" ADD CONSTRAINT "growth_ops_invite_queue_campaign_id_growth_ops_invite_campaigns_id_fk" FOREIGN KEY ("campaign_id") REFERENCES "public"."growth_ops_invite_campaigns"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "growth_ops_invite_queue" ADD CONSTRAINT "growth_ops_invite_queue_target_id_growth_ops_invite_targets_id_fk" FOREIGN KEY ("target_id") REFERENCES "public"."growth_ops_invite_targets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "growth_ops_invite_queue" ADD CONSTRAINT "growth_ops_invite_queue_linkedin_account_id_growth_ops_linkedin_accounts_id_fk" FOREIGN KEY ("linkedin_account_id") REFERENCES "public"."growth_ops_linkedin_accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "growth_ops_invite_targets" ADD CONSTRAINT "growth_ops_invite_targets_list_id_growth_ops_target_lists_id_fk" FOREIGN KEY ("list_id") REFERENCES "public"."growth_ops_target_lists"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "growth_ops_messages" ADD CONSTRAINT "growth_ops_messages_linkedin_account_id_growth_ops_linkedin_accounts_id_fk" FOREIGN KEY ("linkedin_account_id") REFERENCES "public"."growth_ops_linkedin_accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "legacy_users" ADD CONSTRAINT "legacy_users_firm_id_service_firms_id_fk" FOREIGN KEY ("firm_id") REFERENCES "public"."service_firms"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "legacy_users" ADD CONSTRAINT "legacy_users_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "network_connections" ADD CONSTRAINT "network_connections_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "unmapped_industries" ADD CONSTRAINT "unmapped_industries_mapped_to_id_industries_id_fk" FOREIGN KEY ("mapped_to_id") REFERENCES "public"."industries"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "net_rel_user_domain_provider_idx" ON "network_relationships" USING btree ("user_id","firm_domain","provider");